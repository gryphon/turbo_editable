module TurboEditable
  ...
  module IconsHelper
    ...
    def editable_check_icon
      ...
      return editable_icon("ti ti-check") if TurboEditable.configuration.icons_framework == :ti
    end

    def editable_save_icon
      return editable_icon("fa fa-check") if TurboEditable.configuration.icons_framework == :fa
      return editable_icon("bi bi-floppy") if TurboEditable.configuration.icons_framework == :bi
      return editable_icon("ti ti-device-floppy") if TurboEditable.configuration.icons_framework == :ti
    end
    ...
    def editable_x_icon
      ...
      return editable_icon("ti ti-x") if TurboEditable.configuration.icons_framework == :ti
    end
    ...
    def editable_pen_icon
      ...
      return editable_icon("ti ti-pencil text-black") if TurboEditable.configuration.icons_framework == :ti
    end
    ...
    def editable_trash_icon
      ...
      return editable_icon("ti ti-trash text-black") if TurboEditable.configuration.icons_framework == :ti
    end
